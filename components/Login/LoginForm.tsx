    ...
    <form className="flex flex-col justify-center items-center gap-4">
      <div className="flex flex-col gap-2 w-11/12">
        ...
        <div className="flex items-center justify-end p-1 text-sm text-green-500 cursor-pointer hover:underline hover:text-green-600">
          <span className="select-none font-semibold">Forgot password?</span>
        </div>
        <button className="p-2 text-gray-600 font-semibold border-2 border-gray-300 transition-all ease-linear hover:border-green-500 hover:bg-green-500 hover:text-white disabled:bg-gray-400">
          Log in
        </button>
